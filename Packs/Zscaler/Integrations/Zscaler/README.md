...
<p>In order that the integration will work properly, one must use a Zscaler user with admin permissions.
For SAML based account (SSO authentication), create a local admin account in DLP instance.</p>
